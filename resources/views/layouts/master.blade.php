                ...
                <div class="header-navbar">
                    <nav class="navbar">
                        ...
                        <div class="collapse navbar-collapse" id="main_nav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link {{Route::currentRouteName() == 'root' ? 'active' : ''}}" href="{{route('root')}}"> Home </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{Route::currentRouteName() == 'frontend.blog' ? 'active' : ''}}" href="{{route('frontend.blog')}}"> Blogs </a>
                                </li>
                                <li class="nav-item">
